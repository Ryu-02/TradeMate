...
이 프로젝트를 만들 수 있게 도와준 오픈소스 커뮤니티에 감사드립니다.

---

<div align="center">

**⭐️ 이 프로젝트가 도움이 되었다면 Star를 눌러주세요! ⭐️**

Made with ❤️ by Yumyeong-gyu
...
TradeMate는 트레이더를 위한 **직관적인 매매 기록 관리 애플리케이션**입니다.  
깔끔한 UI/UX와 강력한 백엔드를 기반으로 매매 데이터를 쉽고 빠르게 기록할 수 있습니다.

### 💡 왜 TradeMate인가요?

- ✅ **간단한 기록 관리** — 클릭 몇 번으로 매매 내역 입력
- ✅ **빠른 조회** — PostgreSQL 기반의 빠른 응답
- ✅ **반응형 UI** — 모바일·PC 완벽 대응
- ✅ **타입 안정성** — 전부 TypeScript로 작성된 안정된 코드
...
| 기능             | 설명                          |
| ---------------- | ----------------------------- |
| 📝 CRUD          | 매매 기록 생성·조회·수정·삭제 |
| 🎯 모달 입력     | 직관적인 모달 기반 입력 폼    |
| ➕ 플로팅 버튼   | 언제든 새 매매기록 추가       |
| 📱 반응형 디자인 | 모든 환경에서 최적 UI         |
| 🔌 API 분리      | 프론트·백엔드 완전 분리 구조  |
...
⭐️ **프로젝트가 도움이 되었다면 Star를 눌러주세요!** ⭐️  
Made with ❤️ by Yumyeong-gyu
